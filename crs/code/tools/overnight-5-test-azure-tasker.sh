...
warn "Triggering tika delta 01 task to our Azure lax neverending."
curl -u "${COMPETITION_API_TEAM_ID}":"${COMPETITION_API_TEAM_SECRET}" -X 'POST' 'https://api.aixcc.tech/v1/request/ex3-tk-delta-01/' -d '{"duration_secs":2700}'
sleep 30s;
...
warn "Triggering tika delta 03 task to our Azure lax neverending."
...
warn "Triggering sqlite3 delta 01 task to our Azure lax neverending."
...
warn "Triggering sqlite3 delta 03 task to our Azure lax neverending."
curl -u "${COMPETITION_API_TEAM_ID}":"${COMPETITION_API_TEAM_SECRET}" -X 'POST' 'https://api.aixcc.tech/v1/request/ex3-sq-delta-03/' -d '{"duration_secs":10800}'
sleep 30s;

warn "Triggering tika delta 04 task to our Azure lax neverending."
...
warn "Triggering integration test delta 01 task to our Azure lax neverending."
curl -u "${COMPETITION_API_TEAM_ID}":"${COMPETITION_API_TEAM_SECRET}" -X 'POST' 'https://api.aixcc.tech/v1/request/ex3-integration-test-delta-01/' -d '{"duration_secs":10800}'
sleep 30s;
