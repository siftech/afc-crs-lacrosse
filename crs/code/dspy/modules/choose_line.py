...
@models.with_escalation([models.gpt4o_100, models.sonnet37, models.gpt41, models.sonnet4, models.gemini25pro])
def choose_line(lines, criterion, hint="None."):
    pred = chooser(lines=lines, criterion=criterion, hint=hint)
